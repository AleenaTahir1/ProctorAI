...
function initializeDashboardData() {
    ...
    // Dashboard data is already defined below
}
...
// Function to initialize dashboard sections
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            if (e.key === 'Enter') {
                ...
                if (searchTerm) {
                    ...
                    if (activeSection.id === 'quizzes-section') {
                        ...
                        showNotification('Info', 'Search is available in Quizzes and Submissions sections', 'info');
                    }
                }
            }
        });
    ...
    // Add first question to quiz creation form
    const questionsContainer = document.querySelector('#create-quiz-section .questions-container');
    if (questionsContainer && questionsContainer.children.length === 0) {
        addNewQuestion(questionsContainer);
    }
